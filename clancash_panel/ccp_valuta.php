...
echo "<table class='tbl-border' cellspacing='1' cellpadding='0' style='width:100%'>
      <tr>";
			...
			<td align='left' >".$locale['ccp151']."</td>";
		if (checkgroup("$set_admin_id")){
		...
		echo"
          ...
          <div id='box_konten'"; if($openkonten=="off"){ echo "style='display:none'"; } echo ">\n
          ...
          <div id='box_view'"; if($openview=="off"){ echo "style='display:none'"; } echo ">\n";
