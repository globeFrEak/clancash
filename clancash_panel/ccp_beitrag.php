    ...
    <table class='tbl-border' width='100%'>
          ...
          if ($set_member_id == 0 || 101 || 102 || 103){
            ...
            while ($data = dbarray($result)){              
              ...
              {
                  $db_total = dbarray(dbquery("SELECT SUM(valuta) AS total FROM ".DB_CCP_BUCHUNGEN." WHERE jahr='$view_jahr' AND monat='$count_monat' AND user_id='".$data['user_id']."' AND geloescht='0'"));${"total_".$count_monat} = $db_total['total'];
              }
