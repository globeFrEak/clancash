...
opentable($locale['ccp306'].": v1.4 => v1.5");

$mysql[] = "UPDATE ".DB_CCP_SETTINGS." SET version='1.5'";

$mysql[] = "UPDATE ".DB_INFUSIONS." SET inf_version='1.5' WHERE inf_folder='clancash_panel'";
